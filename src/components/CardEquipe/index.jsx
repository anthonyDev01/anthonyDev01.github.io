      ...
      <div>
        ...
        <div className="redesContainer">
          <a className="rede" href={props.redes.instagram} target="_blank">
            <img src={props.tema === "light" ? instagram : instagramBranco} alt="instagram" />
          </a>
          <a className="rede" href={props.redes.linkedin} target="_blank">
            <img src={props.tema === "light" ? likedinPreto : likedinBranco} alt="likedinPreto " />
          </a>
          <a className="rede" href={props.redes.gitHub} target="_blank">
            <img src={props.tema === "light" ? gitHub : gitHubBranco} alt="gitHub" />
          </a>
        </div>
      </div>
    </div>
